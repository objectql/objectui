...
<InteractiveDemo
  schema={{
    ...
    data: [
      ...
      },
      {
        ...
        start: new Date(new Date(new Date().setDate(new Date().getDate() + 1)).setHours(11, 0, 0, 0)).toISOString(),
        end: new Date(new Date(new Date().setDate(new Date().getDate() + 1)).setHours(11, 30, 0, 0)).toISOString(),
        color: "#10b981",
        allDay: false
      },
      {
        id: 4,
        title: "Team Lunch",
        start: new Date(new Date(new Date().setDate(new Date().getDate() + 2)).setHours(12, 0, 0, 0)).toISOString(),
        end: new Date(new Date(new Date().setDate(new Date().getDate() + 2)).setHours(13, 0, 0, 0)).toISOString(),
        color: "#f59e0b",
        allDay: false
      }
    ],
  ...
  description="Calendar with weekly time-slot layout for scheduling"
/>
