...
- 💼 Visual deal pipeline (drag-and-drop Kanban)
- 📊 Sales analytics and reporting
- 📧 Activity timeline and communications
...
├── src/
│   ├── schemas/
│   │   ├── dashboard.schema.ts      # Main dashboard
│   │   ├── contacts.schema.ts       # Contacts list & detail
│   │   ├── companies.schema.ts      # Companies management
│   │   ├── deals.schema.ts          # Deal pipeline (Kanban)
│   │   ├── activities.schema.ts     # Activity timeline
│   │   └── reports.schema.ts        # Analytics & reports
│   ├── api/
│   │   ├── contacts/
│   │   ├── companies/
│   │   ├── deals/
...
│   │   └── reports/
│   ├── components/
│   │   ├── DealCard.tsx            # Custom deal card component
│   │   ├── ActivityTimeline.tsx    # Activity visualization
...
- [**Video Tutorial**](/docs/guide/video-tutorials#crm-system)
