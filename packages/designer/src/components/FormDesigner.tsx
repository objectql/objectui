...
import { FormComponentPalette } from './FormComponentPalette';
...
/**
 * FormDesigner Content Component
 * Handles keyboard shortcuts and layout for form-specific designer
 */
    ...
    <div className="h-full flex flex-col bg-white text-gray-900 font-sans">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-64 md:w-72 flex-shrink-0 z-10 shadow-[1px_0_5px_rgba(0,0,0,0.03)] h-full">
          <FormComponentPalette className="h-full border-r-0" />
        </div>
 ...
 * A specialized designer focused on creating and editing forms
 * 
 * @example
 * ```tsx
 ...
 * ```
 */
export const FormDesigner: React.FC<FormDesignerProps> = ({ initialSchema, onSchemaChange }) => {
