...
const ar = {
  ...
  appDesigner: {
    ...
    objectManager: {
      ...
      deleteConfirmMessage: 'سيتم حذف الكائن وجميع حقوله نهائيًا. لا يمكن التراجع عن هذا الإجراء.',
    },
    fieldDesigner: {
      title: 'مصمم الحقول',
      addField: 'حقل جديد',
      ...
      deleteConfirmMessage: 'سيتم حذف الحقل نهائيًا. ستفقد البيانات الموجودة في هذا الحقل.',
    },
  },
  console: {
