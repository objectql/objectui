...
const fr = {
  ...
  appDesigner: {
    ...
    objectManager: {
      ...
      deleteConfirmMessage: 'L\'objet et tous ses champs seront définitivement supprimés. Cette action est irréversible.',
    },
    fieldDesigner: {
      ...
      deleteConfirmMessage: 'Le champ sera définitivement supprimé. Les données existantes seront perdues.',
    },
  },
  console: {
