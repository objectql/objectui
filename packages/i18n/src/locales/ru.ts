...
const ru = {
  ...
  detail: {
    ...
    deleteRow: 'Удалить',
    deleteRowConfirmation: 'Вы уверены, что хотите удалить эту запись?',
    actions: 'Действия',
    previousPage: 'Назад',
    nextPage: 'Далее',
  ...
  appDesigner: {
    ...
    objectManager: {
      ...
      fieldCount: '{{count}} полей',
      ungrouped: 'Без группы',
      deleteConfirmTitle: 'Удалить объект?',
      deleteConfirmMessage: 'Объект и все его поля будут удалены безвозвратно. Это действие невозможно отменить.',
    },
    fieldDesigner: {
      title: 'Дизайнер полей',
      addField: 'Новое поле',
      ...
      trackHistory: 'Отслеживание истории',
      ...
      deleteConfirmMessage: 'Поле будет удалено безвозвратно. Существующие данные будут потеряны.',
    },
  },
  console: {
